...
* I used [node-beanstalkd](https://github.com/robinjoseph08/node-beanstalkd) client to execute request to the beanstalkd server. (I have `require('./node-beanstalkd');` in the code and added the library file in this repository in the case that node-beanstalkd is not installed.) 
