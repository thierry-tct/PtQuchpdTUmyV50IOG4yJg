...
* The work result is stored into[mongolab](https://mongolab.com/welcome/) database: `currency_conversion_rate`, collection: `currency_conversion_rate_coll`, API-Key: `JbZiHSs9zVVkrKHbKUGQC82a3LTwmoIW`.
